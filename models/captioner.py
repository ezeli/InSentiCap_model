    ...
    def forward_rl(self, fc_feats, att_feats, concepts,
        ...
        for t in range(max_seq_len):
            logprobs, state = self.forward_step(
                it, fc_feats, att_feats, cpt_feats, p_att_feats, p_cpt_feats, state,
                senti_feats, senti_word_feats, p_senti_word_feats)
        ...
        for t in range(max_seq_len):
            ...
            for candidate in candidates:
                ...
                if t > 0 and last_word_id == self.eos_id:
                    ...
                    end_flag = False
                    it = concepts.new_tensor([last_word_id])  # [1, emb_dim]
                    logprobs, state = self.\
