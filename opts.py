...
def parse_opt():
    ...
    parser.add_argument('--rl_xe_resume', type=str, default='checkpoint/xe/new/model_25_2.6744_2.2833_0627-0133.pth')
    ...
    parser.add_argument('--sentence_sentiment_classifier_rnn', type=str, default='./checkpoint/sent_senti_cls/new/model_15_0.0043_0.0110_0628-1122.pth')
